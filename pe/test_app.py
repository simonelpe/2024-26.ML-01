...
def test_hello(client):
    ...
    assert data['stats']['latency'] is not None, "La latenza non deve essere None"
    assert isinstance(data['stats']['latency'], float), "La latenza è un float"
    assert data['stats']['latency'] > 0, "La latenza deve essere positiva"
    assert data['stats']['latency'] < 10, "La latenza deve essere inferiore a 10 secondi"
