...
def test_hello(client):
    ...
    assert data['stats']['model_latency'] is not None, "La latenza non deve essere None"
    assert isinstance(data['stats']['model_latency'], float), "La latenza è un float"
    assert data['stats']['model_latency'] > 0, "La latenza deve essere positiva"
    assert data['stats']['model_latency'] < 10, "La latenza deve essere inferiore a 10 secondi"
